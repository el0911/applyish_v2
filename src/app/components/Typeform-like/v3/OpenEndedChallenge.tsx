  ...
  return (
    ...
    >
      <div className="text-center">
        ...
        <h1 className="text-2xl font-bold mt-2 text-gray-900 dark:text-white">What&apos;s your biggest job search challenge right now?</h1>
      </div>
      <textarea
        value={challenge}
        onChange={(e) => setChallenge(e.target.value)}
        placeholder="e.g., Not getting responses, too many rejections, don't know where to start..."
        className="mt-8 w-full h-40 p-4 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-500 dark:text-white dark:placeholder-gray-400"
        style={{maxWidth: 500, height: 150, padding: 16, borderRadius: 8, margin: 'auto'}}
      />
      <p className="mt-2 text-sm text-gray-600 dark:text-gray-300 text-center">Optional — but helps us personalize your onboarding call</p>
      <button
        onClick={handleNext}
