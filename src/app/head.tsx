...
export default function Head() {
  return (
    <>
      ...
      <meta property="og:image" content="hhttps://placehold.co/1200x600.png?text=applyish" />
      ...
      <meta name="twitter:image" content="hhttps://placehold.co/1200x600.png?text=applyish" />
    </>
  );
}
