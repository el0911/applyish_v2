...
export default function Head() {
  return (
    <>
      ...
      <meta property="og:image" content="https://via.placeholder.com/1200x630.png?text=Applyish+OG+Image" />
      ...
      <meta name="twitter:image" content="https://via.placeholder.com/1200x630.png?text=Applyish+OG+Image" />
    </>
  );
}
