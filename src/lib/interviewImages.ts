/**
 * This file contains the list of Cloudinary URLs for the interview success story images.
 * Replace these placeholder URLs with your actual Cloudinary image URLs.
 */
export const interviewImages: string[] = [
